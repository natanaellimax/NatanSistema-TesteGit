// -----------SISTEMA SquadTrade HB - VERSÃO 1.50 -------------
...
function debug(msg, data) {
  console.log('[SquadTrade] ' + msg, data || '');
}
...
function saudarEExibirPopup(cpf) {
  ...
  const mensagem = `Olá, ${nome}!<br><br>${saudacao}<br><br>Você fez login com sucesso ao Sistema SquadTrade HB.`;
